...
## Languages & Tools
![Languages](https://skillicons.dev/icons?i=c,cpp,python,java,javascript,typescript&perline=6)  
![Frontend](https://skillicons.dev/icons?i=react,nextjs,html,css,tailwind,nodejs&perline=6)  
![Backend](https://skillicons.dev/icons?i=express,firebase,mongodb,supabase,postgresql,vercel&perline=6)  
![Cloud](https://skillicons.dev/icons?i=cmake&perline=5)  
